...
No fixed benchmark claim is made in this README because the dataset and trained model checkpoint are not included. Any metrics, confusion matrices and plots should be generated by running the current code.
